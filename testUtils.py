...
nasdaqEventStream_NEGATIVE_LOWEST_POSITION = FileInputStream(os.path.join(absolutePath, "test/EventFiles/NASDAQ_LONG_CUSTOM.txt"))
...
def runTest(testName, patterns, createTestFile=False,
    ...
    listCustom2 = ["simpleNot", "simpleNotLowest"]
    listLowestPoistion = ["testLowestPositionWithBigData"]
    ...
    elif expected_file_name in listLowestPoistion:
        events = nasdaqEventStream_NEGATIVE_LOWEST_POSITION.duplicate()
